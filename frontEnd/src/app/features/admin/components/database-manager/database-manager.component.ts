...
export class DatabaseManagerComponent implements OnInit {
  ...
  getStatus() {
    this.loading = true;
    this.http.get(`${environment.apiUrl}/database/status`, { withCredentials: true })
      .subscribe({
        next: (response: any) => {
          this.loading = false;
  ...
  cleanServiceResources() {
    ...
    this.http.post(`${environment.apiUrl}/database/clean-service-resources`, {}, { withCredentials: true })
      .subscribe({
        next: (response: any) => {
          this.loading = false;
          this.success = true;
  ...
  cleanCustomerResources() {
    ...
    this.http.post(`${environment.apiUrl}/database/clean-customer-resources`, {}, { withCredentials: true })
      .subscribe({
        next: (response: any) => {
          this.loading = false;
          this.success = true;
  ...
  cleanAllResources() {
    ...
    this.http.post(`${environment.apiUrl}/database/clean-all-resources`, {}, { withCredentials: true })
      .subscribe({
        next: (response: any) => {
          this.loading = false;
          this.success = true;
  ...
  createFreshServiceResources() {
    ...
    this.http.post(`${environment.apiUrl}/database/create-fresh-service-resources`, {}, { withCredentials: true })
      .subscribe({
        next: (response: any) => {
          this.loading = false;
          this.success = true;
  ...
  createFreshCustomerResources() {
    ...
    this.http.post(`${environment.apiUrl}/database/create-fresh-customer-resources`, {}, { withCredentials: true })
      .subscribe({
        next: (response: any) => {
          this.loading = false;
          this.success = true;
